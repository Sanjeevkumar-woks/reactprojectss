    ...
    return (
        <Stack  p={5} 
            ...
            <Flex w="100%" alignItems={'center'}>
                ...
                <Spacer></Spacer>
                <IconButton as={Link} href={'https://www.linkedin.com/in/sanjeevkumar-managutti-34187a207/'} isExternal ml={2} icon={<FaLinkedin />} isRound="true"></IconButton>
                <IconButton as={Link} href={'https://github.com/Sanjeevkumar-woks'} isExternal ml={2} mr={{ base: 0, sm: 8 }} icon={<FaGithub />} isRound="true"></IconButton>
